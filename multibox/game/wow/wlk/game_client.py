...
class GameClient(AttrsClass):
    ...
    choose_char_1_x: int = attr.ib(default=None)
    choose_char_1_y: int = attr.ib(default=None)
    choose_char_2_x: int = attr.ib(default=None)
    choose_char_2_y: int = attr.ib(default=None)
    choose_char_3_x: int = attr.ib(default=None)
    choose_char_3_y: int = attr.ib(default=None)
    choose_char_4_x: int = attr.ib(default=None)
    choose_char_4_y: int = attr.ib(default=None)
    choose_char_5_x: int = attr.ib(default=None)
    choose_char_5_y: int = attr.ib(default=None)
    choose_char_6_x: int = attr.ib(default=None)
    choose_char_6_y: int = attr.ib(default=None)
    choose_char_7_x: int = attr.ib(default=None)
    choose_char_7_y: int = attr.ib(default=None)
    choose_char_8_x: int = attr.ib(default=None)
    choose_char_8_y: int = attr.ib(default=None)
    choose_char_9_x: int = attr.ib(default=None)
    choose_char_9_y: int = attr.ib(default=None)
