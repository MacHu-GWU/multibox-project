...
class ActiveCharactersFactory:
    @property
    def x5p_r_abcde(self) -> T.List[Character]:
        return CharacterHelper.set_team_leader_and_tank(
            chars=[
                char_fact.ra_pve_protect_pala.set_leader_12_and_tank_12().set_dr_pala_12(),
