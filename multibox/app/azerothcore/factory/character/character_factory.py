...
from multibox.app.azerothcore.factory.account import Accounts
...
class CharacterGroup:
    @property
    def r_abcde_fghij(self) -> T.List[Character]:
        return [
    ...
    @property
    def r_a_to_y(self) -> T.List[Character]:
        return [
            char_fact.ra_pve_protect_pala,
            char_fact.rb_pve_elemental_shaman,
            char_fact.rc_pve_balance_druid,
